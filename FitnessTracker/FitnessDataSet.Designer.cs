...
SELECT ActivityID, ActivityName, MetricOne, MetricTwo, MetricThree FROM Activitytb WHERE (ActivityID = @ActivityID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"INSERT INTO [Activitytb] ([ActivityID], [ActivityName], [MetricOne], [MetricTwo], [MetricThree]) VALUES (@ActivityID, @ActivityName, @MetricOne, @MetricTwo, @MetricThree);
SELECT ActivityID, ActivityName, MetricOne, MetricTwo, MetricThree FROM Activitytb WHERE (ActivityID = @ActivityID)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ActivityName", global::System.Data.SqlDbType.VarChar, 100, global::System.Data.ParameterDirection.Input, 0, 0, "ActivityName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
